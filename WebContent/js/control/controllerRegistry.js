...
REGISTRY
***/
gecoRegistryControllers.controller('CompanyCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
...
gecoRegistryControllers.controller('BankListCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
    $scope.loginuser = LoginFactory.checklogin();
...
gecoRegistryControllers.controller('BankDetailCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
...
gecoRegistryControllers.controller('ProductListCtrl',["$scope","$rootScope","$http","ScopeFactory","$location",'LoginFactory',function($scope,$rootScope,$http,ScopeFactory,$location,LoginFactory){
...
gecoRegistryControllers.controller('ProductDetailCtrl',["$scope","$http","$routeParams","$location","$rootScope",'LoginFactory',function($scope,$http,$routeParams,$location,$rootScope,LoginFactory){
    LoginFactory.checklogin();
	GECO_validator.startupvalidator();
...
gecoRegistryControllers.controller('ListListCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
    $scope.loginuser = LoginFactory.checklogin();
...
gecoRegistryControllers.controller('ListDetailCtrl',["$scope","$http","$routeParams","ScopeFactory",'LoginFactory',function($scope,$http,$routeParams,ScopeFactory,LoginFactory){
    LoginFactory.checklogin();
	GECO_validator.startupvalidator();
...
/****
	CUSTOMER
**/
gecoRegistryControllers.controller('CustomerListCtrl',["$scope","$http","$rootScope","KeyDown",'LoginFactory',function($scope,$http,$rootScope,KeyDown,LoginFactory){
     LoginFactory.checklogin();
...
gecoRegistryControllers.controller('CustomerDetailCtrl',["$scope","$http","$routeParams","KeyDown","$rootScope","$location",'LoginFactory',function($scope,$http,$routeParams,KeyDown,$rootScope,$location,LoginFactory){
    LoginFactory.checklogin();
	GECO_validator.startupvalidator();
	...
	$scope.fillTransporter = function(){
		if ($scope.transporters !== null && $scope.transporters != undefined && $scope.customer.transporter !== null && $scope.customer.transporter !== undefined   ){
...
/****
	DESTINATION
**/
gecoRegistryControllers.controller('DestinationListCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
    $scope.loginuser = LoginFactory.checklogin();
...
gecoRegistryControllers.controller('DestinationDetailCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
    //LoginFactory.checklogin();
	GECO_validator.startupvalidator();
...
/****
	SUPPLIER
**/
gecoRegistryControllers.controller('SupplierListCtrl',["$scope","$http","$rootScope",'LoginFactory',function($scope,$http,$rootScope,LoginFactory){
    //$scope.loginuser = LoginFactory.checklogin();
	if ($scope.pagesize == null ){
		$scope.pagesize = 99;
		//ScopeFactory.factory.productList.pagesize = 100;
...
gecoRegistryControllers.controller('SupplierDetailCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
    //LoginFactory.checklogin();
...
/****
	TRANSPORTER
**/
gecoRegistryControllers.controller('TransporterListCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
    //$scope.loginuser = LoginFactory.checklogin();
	$http.get('rest/registry/transporter').success(function(data){
		$scope.transporters= data;
	});
...
gecoRegistryControllers.controller('TransporterDetailCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
    //LoginFactory.checklogin();
	$scope.listsections = ["Dettagli","Listini","Destinazioni"];
	$scope.selectedSection = $scope.listsections[0];
	GECO_validator.startupvalidator();
