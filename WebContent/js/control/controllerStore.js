...
REGISTRY
***/
gecoStoreControllers.controller('StoreCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
...
gecoStoreControllers.controller('ReportOrderCtrl',["$scope","$http",'LoginFactory',function($scope,$http,LoginFactory){
    LoginFactory.checklogin();
	$scope.filterObj = {};
	$scope.neededObj = {};
