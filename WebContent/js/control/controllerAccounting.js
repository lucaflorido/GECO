...
REGISTRY
***/
gecoAccountingControllers.controller('AccountingCustomerCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
...
gecoAccountingControllers.controller('AccountingListCtrl',["$scope","$http","$routeParams",'LoginFactory',function($scope,$http,$routeParams,LoginFactory){
	LoginFactory.checklogin();
	$scope.total = 0.0;
